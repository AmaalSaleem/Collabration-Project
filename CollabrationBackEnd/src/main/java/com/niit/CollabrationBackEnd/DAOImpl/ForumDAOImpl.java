...
@Transactional
	...
	Session session = sessionFactory.openSession();
	ArrayList<ForumRequests> myforums=(ArrayList<ForumRequests>)session.createQuery("from ForumRequests where user_id="+myid+" and status='A'").list();
	session.close();
	return myforums;
	}
@Transactional
	...
	Session session = sessionFactory.openSession();
	ArrayList<ForumRequests> myforums=(ArrayList<ForumRequests>)session.createQuery("from ForumRequests where user_id="+myid+" and forumid="+ForumId).list();
	session.close();
	return myforums;
	}
@Transactional
public ArrayList<ForumRequests> forreqbyforid(int forumid) {
	Session session = sessionFactory.openSession();
	ArrayList<ForumRequests> forumsbyforid=(ArrayList<ForumRequests>)session.createQuery("from ForumRequests where forumid="+forumid+" and status='A'").list();
	session.close();
