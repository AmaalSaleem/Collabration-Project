app.controller("picuploadcontroller", function ($scope,$location,$http,$rootScope,$cookieStore) {
	 ...
	 $http.post("http://localhost:8080/CollabrationMiddleWare/user/login",$rootScope.currentuser).then(function(response)
			 {
...
app.controller("registercontroller", function ($scope,$location,$http,$rootScope,$cookieStore) {
	 ...
	 $scope.register=function()
	 {
		 ...
		 $http.post("http://localhost:8080/CollabrationMiddleWare/user/register",$scope.User).then(function(response){
	 ...
	 $scope.login=function()
	 {
		 ...
		 $http.post("http://localhost:8080/CollabrationMiddleWare/user/login",$scope.User).then(function(response)
				 {
...
console.log("in logout controller")
	 $scope.logout=function()
	 {
		 ...
		 console.log( $rootScope.currentuser.email_id)
			$http.get("http://localhost:8080/CollabrationMiddleWare/user/logout/"+ $rootScope.currentuser.email_id)
...
app.controller("userrequestcontroller", function ($scope,$http,$location,$rootScope,$cookieStore) {
	function fetchAlluserreq()
	{
	 ...
	 $http.get("http://localhost:8080/CollabrationMiddleWare/user/getAllUsersreq")
	    .then(function(response)
	    		{
	...
	fetchAlluserreq();
	 ...
	 $scope.acceptuserrequests=function(id)
	 {
		...
		console.log("in user request  accept method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/user/approveusers/"+id).then(fetchAlluserreq(),function(response){
	 ...
	 $scope.rejectuserrequests=function(id)
	 {
		...
		console.log("in user request  reject method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/user/rejectusers/"+id).then(fetchAlluserreq(),function(response){
