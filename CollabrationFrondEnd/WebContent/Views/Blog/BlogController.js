app.controller("blogcontroller", function ($scope,$http,$location,$rootScope,$cookieStore,$route) {
	...
	{
	$http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getAllBlogs")
	...
	function myallblogs()
	{
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getAllMyBlogs/"+$rootScope.currentuser.user_id)
		.then(function(response)
		{
	...
	function fetchBlogById(idd)
	{
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getBlogById/"+idd).then(function(response){
	 ...
	 function getSelectedBlog(idd)
	 {
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getAllBlogComments/"+idd)
			.then(function(response)
			{
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/incview/"+idd).then(function(response){
	...
	console.log("current user data :",$rootScope.currentuser)
		 $http.post("http://localhost:8080/CollabrationMiddleWare/blogs/addBlog",$scope.Blog).then(fetchAllBlogs(),function(response){
	...
	console.log("scope blog",$scope.Blog)
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/updateBlog/"+$rootScope.eblog.blogid+"/"+$scope.Blog.blogname+"/"+$scope.Blog.blogcontent).then(function(response){
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getBlogById/"+$rootScope.eblog.blogid).then(function(response){
			 $route.reload();
				$rootScope.eblog=response.data; 
	 ...
	 $scope.deleteBlog=function(idd)
	 {
		console.log("in delete blog method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/deleteBlog/"+idd).then(fetchAllBlogs(),function(response){
	 ...
	 $scope.rejetcBlog=function(idd)
	 {
		console.log("in reject blog method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/rejectBlog/"+idd).then(fetchBlog(idd),fetchAllBlogs(),function(response){
	 ...
	 $scope.likeBlog=function(idd)
	 {
		console.log("in like blog method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/likeBlog/"+idd).then(function(response){
	 ...
	 {
		console.log("in like blog method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/dislikeBlog/"+idd).then(fetchBlogById(idd),function(response){
	 ...
	 $scope.addBlogComment=function()
	 {
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/blogs/addBlogComments/"+$rootScope.gblog.blogid+"/"+$rootScope.currentuser.user_id+"/"+$scope.BlogComment.blogcomm+"/"+$rootScope.currentuser.email_id).then(function(response){
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getAllBlogComments/"+$rootScope.gblog.blogid)
		.then(function(response)
		{
	 ...
	 $scope.updateBlogComment=function(idd)
	 {
		console.log("in update blogComment method")
		 $http.post("http://localhost:8080/CollabrationMiddleWare/blogs/updateBlogComments/"+idd,$scope.BlogComments).then(function(response){
	 ...
	 $scope.deleteBlogComment=function(idd)
	 {
		console.log("in delete blogcomment method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/deleteBlogComment/"+idd).then(function(response){
...
app.controller("blogrequestcontroller", function ($scope,$http,$location,$rootScope) {
	function fetchAllblogreq()
	{
	 ...
	 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/blogrequests")
	    .then(function(response)
	    		{
	...
	fetchAllblogreq();
	 ...
	 $rootScope.acceptblogrequests=function(id)
	 {
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/approveblogRequests/"+id).then(fetchAllblogreq(),function(response){
	 ...
	 $rootScope.rejectblogrequests=function(id)
	 {
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/blogs/rejectblogRequests/"+id).then(fetchAllblogreq(),function(response){
