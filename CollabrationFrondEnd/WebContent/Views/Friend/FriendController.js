app.controller("friendrequestcontroller", function ($scope,$http,$location,$rootScope) {
	...
	console.log("in unfriend method")
		$http.get('http://localhost:8080/CollabrationMiddleWare/friend/acceptfriend/'+$rootScope.currentuser.user_id+'/'+friendid)
	...
	{
	console.log("in unfriend method")
		$http.get('http://localhost:8080/CollabrationMiddleWare/friend/rejectfriend/'+$rootScope.currentuser.user_id+'/'+friendid)
		.then(fetchAllfriendreq(), function(response) {
...
app.controller("friendcontroller", function ($scope,$http,$location,$rootScope) {
	...
	function fetchAlluser()
	{
	 ...
	 $http.get("http://localhost:8080/CollabrationMiddleWare/user/getAllUsers/"+ $rootScope.currentuser.user_id)
	    .then(function(response)
	    		{
...
*/							
	...
	function fetchAllUsers()
	{
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/friend/getMyFriends/"+ $rootScope.currentuser.user_id)
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/friend/getAllOtherUsers/"+ $rootScope.currentuser.user_id)
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/friend/getOnlineFriends/"+ $rootScope.currentuser.user_id)
	...
	$scope.insertFriend = function(friendid)
	{
		...
		$http.get('http://localhost:8080/CollabrationMiddleWare/friend/addFriend/'+$rootScope.currentuser.user_id+'/'+friendid)
	...
	{
	console.log("in unfriend method")
		$http.get('http://localhost:8080/CollabrationMiddleWare/friend/unfriend/'+$rootScope.currentuser.user_id+'/'+friendid)
		.then(fetchAllUsers(), function(response) {
			console.log("successful friend add ");
			$location.path("/usersearch")
		});
	...
	$rootScope.friendpreview=function(friendid)
	{
		if(friendid==$rootScope.currentuser.user_id)
			...
			{
		$http.get("http://localhost:8080/CollabrationMiddleWare/user/getUser/"+friendid)
	...
	$http.get("http://localhost:8080/CollabrationMiddleWare/user/ismyfriend/"+$rootScope.friendpreviewdata.user_id+"/"+$rootScope.currentuser.user_id)
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/user/friendsfriends/"+$rootScope.friendpreviewdata.user_id+"/"+$rootScope.currentuser.user_id)
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/blogs/getAllMyBlogs/"+$rootScope.friendpreviewdata.user_id)
		.then(function(response)
		{
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/forums/myforums/"+$rootScope.friendpreviewdata.user_id)
		.then(function(response)
		{
...
/*app.controller("userlistcontroller", function ($scope,$http,$location,$rootScope,$cookieStore) {
	function fetchAlluser()
	{
	 ...
	 $http.get("http://localhost:8080/CollabrationMiddleWare/user/getAllUsers")
	    .then(function(response)
	    		{
