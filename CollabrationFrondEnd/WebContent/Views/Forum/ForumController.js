app.controller("forumcontroller", function ($scope,$http,$location,$rootScope,$cookieStore) {
	...
	$http.get("http://localhost:8080/CollabrationMiddleWare/forums/getAllForums")
	...
	function myallforums()
	{
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/forums/myforums/"+$rootScope.currentuser.user_id)
		.then(function(response)
		{
	...
	$location.path('/forumdiscus');
	 ...
	 $scope.addForum=function()
	 {
		...
		console.log($scope.Forum)
		 $http.post("http://localhost:8080/CollabrationMiddleWare/forums/addForum",$scope.Forum).then(fetchAllForums(),function(response){
...
$http.get("http://localhost:8080/CollabrationMiddleWare/forums/getAllForumComments/"+idd)
.then(function(response)
{
...
$http.get("http://localhost:8080/CollabrationMiddleWare/forums/forumreqbyforumid/"+idd)
.then(function(response)
{
...
$scope.fetchforumforedit=function(idd)
{
	...
	$location.path('/updateforum')
	 ...
	 $scope.editForum=function(idd)
	 {
		...
		if($scope.Forum.forumcontent==null)
		 ...
		 $http.post("http://localhost:8080/CollabrationMiddleWare/forums/updateForum/"+idd+"/"+$scope.Forum.forumname+"/"+$scope.Forum.forumcontent).then(fetchAllForums(),function(response){
		 ...
		 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/getForumById/"+$rootScope.eforum.forumid).then(function(response){
				$rootScope.eforum=response.data; 
	 ...
	 $scope.deleteForum=function(idd)
	 {
		console.log("in delete forum method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/deleteForum/"+idd).then(fetchAllForums(),function(response){
 ...
 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/myforums/"+$rootScope.currentuser.user_id).then(function(response){
	 ...
	 $rootScope.sendforumrequests=function(id)
	 {
		...
		/*console.log($rootScope.ForumByid.forumid+$rootScope.currentuser.user_id)*/
		 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/addForumReq/"+id+"/"+$rootScope.currentuser.user_id).then(function(response){
	 ...
	 $rootScope.leaveforum=function()
	 {
		 ...
		 $http.get("http://localhost:8080/SayhiMiddleware/forums/leaveforum/"+$rootScope.ForumByid.forumid+"/"+$rootScope.currentuser.user_id).then(fetchForumByIdd($rootScope.ForumByid.forumid),function(response){
	 ...
	 $scope.addForumComment=function()
	 {
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/forums/addForumComments/"+$rootScope.ForumByid.forumid+"/"+$rootScope.currentuser.username+"/"+$scope.ForumComments.forumcomm).then(function(response){
		...
		$http.get("http://localhost:8080/CollabrationMiddleWare/forums/getAllForumComments/"+$rootScope.ForumByid.forumid)
		.then(function(response)
		{
...
app.controller("forumrequestcontroller", function ($scope,$http,$location,$rootScope) {
	function fetchAllForumreq()
	{
	 ...
	 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/getForumRequests")
	    .then(function(response)
	    		{
	...
	fetchAllForumreq();
	 ...
	 $rootScope.acceptforumrequests=function(id)
	 {
		...
		console.log("in forum request  accept method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/approveForumRequests/"+id).then(fetchAllForumreq(),function(response){
	 ...
	 $rootScope.rejectforumrequests=function(id)
	 {
		...
		console.log("in forum reject method")
		 $http.get("http://localhost:8080/CollabrationMiddleWare/forums/rejectForumRequests/"+id).then(fetchAllForumreq(),function(response){
